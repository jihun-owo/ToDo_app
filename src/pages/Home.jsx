...
const Home = () => {
  ...
  // Initial state as requested: all empty cards
  const recentCalendars = [
    { type: 'empty' },
    { type: 'empty' },
    { type: 'empty' },
    { type: 'empty' },
          ...
          <div className="sidebar" onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ padding: '1rem' }}>
              ...
              <ul style={{ marginTop: '2rem', listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <li style={{ cursor: 'pointer', padding: '0.5rem 0', borderBottom: '1px solid var(--border-color)' }}>홈</li>
                <li style={{ cursor: 'pointer', padding: '0.5rem 0', borderBottom: '1px solid var(--border-color)' }}>캘린더</li>
                <li style={{ cursor: 'pointer', padding: '0.5rem 0', borderBottom: '1px solid var(--border-color)' }}>설정</li>
              </ul>
            </div>
          </div>
        </div>
